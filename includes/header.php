...
<head>
    ...
    <link href="/healthnorth/assets/css/styles.css" rel="stylesheet">
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'liste_des_RDV.php' ? 'active' : '' ?>" href="liste_des_RDV.php">Gestion des rendez-vous</a>
                    </li>
                    <li class="nav-item">
